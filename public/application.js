...
/***/ (function(module, exports, __webpack_require__) {
	...
	var requestsEvents = __webpack_require__(10);

	$(document).on('click', '.add-show-button', function () {
	  var data = $(this).closest('div').data('show-id');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var processSuccessfulLogin = function processSuccessfulLogin() {
	  $('#sign-in').hide();
	  $('#sign-up').hide();
	  $('#needsSignIn').show();
	...
	var processSuccessfulSignOut = function processSuccessfulSignOut() {
	  $('#sign-in').show();
	  $('#sign-up').show();
	  $('#needsSignIn').hide();
	...
	module.exports = {
	  ...
	  processSuccessfulSignOut: processSuccessfulSignOut
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetAllShows = function onGetAllShows() {
	  api.getAllShows().done(ui.getAllShowsSuccess).fail(ui.failure);
	};

	var onGetUsersShows = function onGetUsersShows() {
	  api.getUsersShows().done(ui.getUsersShowsSuccess).fail(ui.failure);
	};

	var onAddShow = function onAddShow(showId) {
	  api.addShow(showId).done(ui.addShowSuccess).fail(ui.failure);
	};

	var onAttendedShow = function onAttendedShow(data) {
	  api.attendedShow(data).done(ui.AttendedSuccess).fail(ui.failure);
	};

	var onRemoveShow = function onRemoveShow(data) {
	  api.removeShow(data).done(ui.removeShowSuccess).fail(ui.failure);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onAddShow: onAddShow,
	  onAttendedShow: onAttendedShow,
	  onRemoveShow: onRemoveShow,
	  onGetAllShows: onGetAllShows,
	  onGetUsersShows: onGetUsersShows
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getAllShows = function getAllShows() {
	  return $.ajax({
	...
	var getUsersShows = function getUsersShows() {
	  return $.ajax({
	...
	var addShow = function addShow(data) {
	...
	var attendedShow = function attendedShow(data) {
	  var buttonID = event.target.id;
	  $('#' + buttonID).hide();
	  return $.ajax({
	...
	var removeShow = function removeShow(data) {
	  var buttonID = event.target.id;
	  $('#' + buttonID).hide();
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var removeShowSuccess = function removeShowSuccess(data) {
	  console.log(data);
	};

	var addShowSuccess = function addShowSuccess(data) {
	  console.log('addShowSuccess data = ', data);
	};

	var getUsersShowsSuccess = function getUsersShowsSuccess(data) {
	  console.log('shows_users data', data);
	  var displayUsersShows = __webpack_require__(13);
	  $('#content').html(displayUsersShows({
	    shows: data.shows
	  }));
	};

	var getAllShowsSuccess = function getAllShowsSuccess(data) {
	  console.log(data);
	  var displayAllShows = __webpack_require__(33);
	...
	module.exports = {
	  success: success,
	  failure: failure,
	  getAllShowsSuccess: getAllShowsSuccess,
	  addShowSuccess: addShowSuccess,
	  getUsersShowsSuccess: getUsersShowsSuccess,
	  attendedShow: attendedShow,
	  removeShowSuccess: removeShowSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<h1> Artist: "
	    ...
	    + " class=\"remove-show-button\"> Remove Show</button>\n\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.attended : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data) {
	    var helper;

	  return "<button id="
	    + container.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"attended-button-hidden\"> Attended</button>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    var helper;

	  return "<button id="
	    + container.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"attended-button\"> Attended?</button>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.shows : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div data-show-id=\""
	    ...
	    + " </h3>\n\n<button id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"add-show-button\"> Add Show </button></div>\n</br>\n<hr>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.shows : depth0)) != null ? stack1.shows : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "835eb4d97f2b21c5aadc08da1ff9bc23.jpg";
